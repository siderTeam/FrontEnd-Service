...
import { COMPLETION_LIST, COMPLETION_LIST_REQUEST } from '@/api/admin/projectCompletion/model';
import { getCompletionList } from '@/api/admin/projectCompletion/api';
...
const Page = () => {
  ...
  const { data } = useQuery({
    queryKey: [rest.get.completionList, params],
    queryFn: ({ queryKey }) => getCompletionList(queryKey[1] as COMPLETION_LIST_REQUEST),
  });
