...
const CheckBox = ({ text, requireText, isChecked = false, disabled = false, name, onChange, style, requireStyle }: CheckboxProps) => {
  return (
    <Container>
      <StyledCheckBox type="checkbox" checked={isChecked} disabled={disabled} name={name} onChange={onChange} style={style} />
