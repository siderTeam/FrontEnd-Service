...
const Radio = ({ text, name, value, requireText, isChecked = false, disabled = false, size = 'big', onChange, style }: RadioProps) => {
  return (
    <Container>
      <StyledRadio type="radio" name={name} value={value} checked={isChecked} disabled={disabled} onChange={onChange} size={size} style={style} />
